...
bool
SOP_Fluid::evalVariableValue(fpreal &val, int index, int thread)
{
...
OP_Node *
SOP_Fluid::myConstructor(OP_Network *net, const char *name, OP_Operator *op)
{
